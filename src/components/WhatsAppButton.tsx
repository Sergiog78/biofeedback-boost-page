...
const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-20 right-[calc(env(safe-area-inset-right)+3.25rem)] sm:right-4 z-40 flex items-center gap-3">
      {/* Tooltip / messaggio */}
      {!dismissed && (
        <a
          href={url}
          ...
          className="relative bg-white text-foreground text-sm font-medium px-4 py-2.5 rounded-xl shadow-lg border border-border max-w-[200px] leading-snug animate-fade-in cursor-pointer hover:shadow-xl transition-shadow"
        >
